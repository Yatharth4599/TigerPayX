              ...
              <div className="relative z-10">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="flex-1 bg-white text-[#ff6b00] py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-lg"
                  >
                    Send
                  </button>
                  <button
                    onClick={() => setShowReceivePaymentModal(true)}
                    className="flex-1 bg-white/20 backdrop-blur-sm text-white border border-white/30 py-3 rounded-xl font-semibold hover:bg-white/30 transition-colors"
                  >
                    Receive
                  </button>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {walletConnected ? (
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 hover:border-orange-400 transition-all text-left"
                  >
                    <div className="w-16 h-16 bg-orange-500 rounded-xl flex items-center justify-center mb-4">
                      <span className="text-3xl">💎</span>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Stables</h3>
                    <p className="text-gray-600 text-sm">Pay with stablecoins</p>
                  </motion.button>
                ) : (
                  <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-6 border-2 border-gray-300 border-dashed text-left relative opacity-60 cursor-not-allowed">
                    ...
                    <div className="w-16 h-16 bg-gray-400 rounded-xl flex items-center justify-center mb-4">
                      <span className="text-3xl">💎</span>
                    </div>
                    <h3 className="text-xl font-semibold text-gray-600 mb-2">Stables</h3>
                    <p className="text-gray-500 text-sm mb-2">Pay with stablecoins</p>
